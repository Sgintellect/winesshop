 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
       <div class="row">
        <div class="col-md-3 listpage"><h4>Shop List</h4></div>
        ...
        <div class="col-md-3"><p style="text-align:right">
          <span><input type="button" name="add" value="Add Shop"  class="button" onclick="location.href='shop_model.php'" /></span>  
          </p>
        </div>
      </div>
    </section>
...
?> 
  <?php 
  $query =mysqli_query($counts,"select * from `tbl_shop_list`");
  ...
  ?>
          ...
          <td>
		   ...
		   <td><?php echo $row['Shop_tpye']; ?></td> 
		   <td><?php echo $row['Shop_address']; ?></td> 
		   <td><?php echo $row['Shop_contactno']; ?></td> 
		   <td><?php echo $row['Shop_document']; ?></td>
<td><?php echo $row['state']; ?></td> 
<td><?php echo $row['city']; ?></td> 		   
		   <td><?php echo $row['date']; ?></td> 
           <td><a href="edit_student.php?edit=<?php echo $row['id']; ?>" class="btn btn-primary"title="edit"> <i class="fa fa-pencil"></i></a>
     <a href="delete_shop.php?id=<?php echo $row['id']; ?>" class="btn btn-primary" title="delete"> <i class="fa fa-trash" aria-hidden="true"></i></a>
</td>  
</tr>
        <?php }?>
