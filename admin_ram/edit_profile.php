...
"); //die;
     ...
     header("location:school_details_list.php");
     exit();
  }      
 ...
 include("config.php");
  ...
  if (isset($_GET['edit'])) {
   ...
   $phone= $_SESSION['phone']; 
       $update = true;
    $record = mysqli_query($counts, "SELECT * FROM `table_profile` WHERE id='$id'
");
  ...
  ?> 
    <section class="content">
      <div class="box box-primary">
		<form name="frm" id="servicefrm" method="POST" enctype="multipart/form-data" action="update_profile.php">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="hidden" name="id" value="<?php echo $id; ?>">
				   <input type="text" name="name"value="<?php echo $full_name ;?>" class="form-control mmm">
...
<input type="text" name="moblie"  value="<?php echo $Mobile ;?>"class="form-control mmm"size="1">
          ...
          <div class="form-group">
            <label>Photo</label>
            <input type="file" name="photo" value="<?php echo $photo ;?>"class='form-control' /><br/>
