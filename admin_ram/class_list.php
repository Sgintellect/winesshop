 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
       <div class="row">
        <div class="col-md-3 listpage"><h4>Manage Class  list</h4></div>
        ...
        <div class="col-md-3"><p style="text-align:right">
          <span><input type="button" name="add" value="Add Class"  class="button" onclick="location.href='class.php'" /></span>  
          </p>
        </div>
      </div>
    </section>
...
?> 
  <?php 
  $query =mysqli_query($counts,"select * from `class`");
  ...
  ?>
    ...
    <td><a href="edit_class.php?edit=<?php echo $row['class_id']; ?>" class="btn btn-primary"title="edit"> <i class="fa fa-pencil"></i></a>
    <a href="delete_class.php?id=<?php echo $row['id']; ?>" class="btn btn-primary" title="delete"> <i class="fa fa-trash" aria-hidden="true"></i></a>
                </td>
                </tr>
        <?php }?>
