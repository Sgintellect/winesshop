 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
       <div class="row">
        <div class="col-md-3 listpage"><h4>City List</h4></div>
        ...
        <div class="col-md-3"><p style="text-align:right">
          <span><input type="button" name="add" value="Add City"  class="button" onclick="location.href='#'" /></span>  
          </p>
        </div>
      </div>
    </section>
...
?> 
  <?php 
  $query =mysqli_query($counts,"select * from `cities`");
  ...
  ?>
     ...
     <a href="delete_student.php?id=<?php echo $row['id']; ?>" class="btn btn-primary" title="delete"> <i class="fa fa-trash" aria-hidden="true"></i></a>
</td>  
</tr>
        <?php }?>
