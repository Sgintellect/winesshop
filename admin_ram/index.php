      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <p class="login-admin-msg">Please enter a valid username and password to gain access to the administration console.</p>
           <a href="<?php echo base_url('Mega_controller/forget'); ?>"">I forgot my password</a><br>
    <a href="<?php echo base_url('Mega_controller/signupFn'); ?>" class="text-center">Register Admin</a>
        </div>
