 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
       <div class="row">
        <div class="col-md-3 listpage"><h4>Category List</h4></div>
        ...
        <div class="col-md-3"><p style="text-align:right">
          <span><input type="button" name="add" value="Add Category"  class="button" onclick="location.href='services-addf.php'" /></span>  
          </p>
        </div>
      </div>
    </section>
...
?> 
  <?php 
  $query =mysqli_query($counts,"select * from `category`");
  ...
  ?>
          ...
          <td>
           ...
           <td><?php echo $row['model_shop']; ?></td> 
           <td><a href=".php?edit=<?php echo $row['id']; ?>" class="btn btn-primary"title="edit"> <i class="fa fa-pencil"></i></a>
     <a href="delete__catogery.php?id=<?php echo $row['id']; ?>" class="btn btn-primary" title="delete"> <i class="fa fa-trash" aria-hidden="true"></i></a>
</td>  
</tr>
        <?php }?>
