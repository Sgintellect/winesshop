 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <div class="row">
      	<div class="col-md-3 listpage"><h4>Manage Enquiry</h4></div>
          ...
          <div class="box">
            <div class="box-body">
              <table id="banner-list" class="table table-bordered table-striped">
				...
				<?php
				$i=1;
				$sql=$obj->query("select * from tbl_enquiry where 1=1 order by id DESC",$debug=-1);
                ...
                <tr>
					...
					<td><?php echo ucfirst(stripslashes($line->email)); ?></td>					
					<td><?php echo ucfirst(stripslashes($line->subject)); ?></td>
					<td><?php echo stripslashes($line->message); ?></td>
					<!-- <td align="center">
					 <label class="switch">
