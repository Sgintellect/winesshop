          ...
          <div class="box">
            ...
            <div class="squaredFour">
                  ...
                  <label for="squaredFour<?php echo $line->id;?>"></label>
					...
					<td><?php echo ucfirst(stripslashes($line->	phone)); ?></td>					
					...
					<td><?php echo ucfirst(stripslashes($line->Date)); ?></td>
					
					<td><?php echo $line->status; ?></td>
					
					<td align="center">
          <label class="switch">
                <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $student_registation?>">
