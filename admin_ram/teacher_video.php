 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <div class="row">
      	<div class="col-md-3 listpage"><h4>Manage Appointment</h4></div>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <!-- /.box -->
		<form name="frm" method="post" action="appointment-del.php" enctype="multipart/form-data">
          <div class="box">
            <div class="box-body">
              <table id="banner-list" class="table table-bordered table-striped">
				...
				<?php
				$i=1;
				$sql=$obj->query("SELECT * FROM `student_registation` WHERE 1=1",$debug=-1);
            ...
            <div class="squaredFour">
                  ...
                  <label for="squaredFour<?php echo $line->id;?>"></label>
					...
					<td><?php echo ucfirst(stripslashes($line->full_name)); ?></td>
					<td><?php echo stripslashes($line->email); ?></td>
					<td><?php echo ucfirst(stripslashes($line->	Mobile)); ?></td>					
					<td><?php echo ucfirst(stripslashes($line->class)); ?></td>
					<td><?php echo ucfirst(stripslashes($line->subject));  ?></td>
					<td><?php echo ucfirst(stripslashes($line->address));  ?></td>
					<td><?php echo ucfirst(stripslashes($line->service)); ?></td>
					<td><?php echo $line->time; ?></td>
					<td><?php echo $line->status; ?></td>
					
					<td align="center">
          <label class="switch">
                <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_appointment?>">
